...
# TODO(phase-5-calibration): the mission brief locks the performer to
# "OpenLLM-France/Luciole-1B-SFT-1.0" (repo to be made public at delivery),
# while PRD §3.1/§6.8 references "Luciole-1B-Instruct-1.1". Verify tokenizer
# parity on the SFT repo and re-calibrate all three thresholds before release.
